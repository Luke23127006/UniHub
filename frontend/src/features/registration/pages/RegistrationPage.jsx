            ...
            <div className="md:w-2/5 p-8 sm:p-10 bg-gray-50/50 dark:bg-gray-800/50 border-b md:border-b-0 md:border-r border-gray-100 dark:border-gray-800 flex flex-col">
              <div className="mb-8">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-4">
                  ...
                  <span className="text-[9px] font-black uppercase tracking-widest text-cyan-600 dark:text-cyan-400">
                    Review Entry
                  </span>
                </div>
              ...
              <div className="space-y-6 flex-1">
                <div>
                  <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1.5 font-mono">
                    Title
                  </p>
            ...
            <div className="md:w-3/5 p-8 sm:p-12 flex flex-col justify-center">
              <header className="mb-10 text-center md:text-left">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mt-4 leading-relaxed">
                  Please verify the information on the left before finalizing
                  your registration.
                </p>
              </header>
              ...
              <div className="space-y-8">
                ...
                <Form method="post">
                  ...
                  >
                    <div
                      className={`relative flex items-center justify-center py-5 px-10 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-2xl font-black uppercase tracking-[0.3em] text-[11px] transition-all duration-300 ${isSubmitting ? "opacity-80" : "hover:shadow-2xl shadow-gray-200 dark:shadow-none"}`}
                    >

 ...
 *
 * Demonstrates how unihub Tailwind tokens map to the "University Tradition"
 * palette and how the ThemeContext drives the dark-mode toggle.
 *
 * University theme  →  deep maroon bar, cream text
 * Dark theme        →  dark surface, light text  (via Tailwind `dark:` variants)
 */

...
async function main() {
  ...
  const speakersData = [
    {
      name: "GS. Alan Turing",
      title: "Cha đẻ ngành Khoa học Máy tính",
      org: "Stanford University",
    },
    {
      name: "TS. Grace Hopper",
      title: "Chuyên gia Hệ thống Phân tán",
      org: "MIT",
    },
    {
      name: "Linus Torvalds",
      title: "Kiến trúc sư trưởng Linux",
      org: "Linux Foundation",
    },
    {
      name: "Vitalik Buterin",
      title: "Người sáng lập Ethereum",
      org: "Ethereum Foundation",
    },
    {
      name: "Don Norman",
      title: "Tác giả The Design of Everyday Things",
  ...
  const workshopsData = [
    {
      title: "Hệ thống Phân tán Quy mô lớn",
      desc: "Kiến trúc và các bài toán thực tế.",
      capacity: 100,
    },
    {
      title: "AI & Generative Models 2024",
      desc: "Ứng dụng LLM trong doanh nghiệp.",
      capacity: 150,
    },
    {
      title: "Web3 & Blockchain Security",
      desc: "Bảo mật hợp đồng thông minh.",
      capacity: 80,
    },
    {
      title: "UX/UI Design for Luxury Tech",
      desc: "Thiết kế giao diện cao cấp.",
      capacity: 60,
    },
    {
      title: "Cloud Native & Kubernetes",
      desc: "Triển khai hạ tầng hiện đại.",
      capacity: 120,
    },
    {
      title: "React Native Performance Tuning",
      desc: "Tối ưu hóa ứng dụng di động.",
      capacity: 90,
    },
    {
      title: "Backend Mastery với Go & Rust",
      desc: "Lập trình hiệu năng cao.",
      capacity: 110,
    },
    {
      title: "Data Engineering at Scale",
      desc: "Xử lý dữ liệu hàng tỷ bản ghi.",
      capacity: 130,
    },
    {
      title: "Cyber Security & Zero Trust",
      desc: "Bảo mật mạng thế hệ mới.",
      capacity: 70,
    },
    {
      title: "Product Management 101",
      desc: "Từ ý tưởng đến sản phẩm triệu đô.",
      capacity: 100,
    },
  ];
  ...
  for (let i = 0; i < workshopsData.length; i++) {
    ...
    const existingWs = await prisma.workshop.findFirst({
  ...
  if (existingUserCount > 90000) {
    console.log(
      `Database already has ${existingUserCount} users. Skipping large scale seeding.`,
    );
  } else {
    console.log(
      "Seeding 100,000 users and students. This might take a minute...",
    );
